...
<body style="font-family: 'Arial', sans-serif; background-color: #f0f0f0; padding: 20px;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        <tr>
            <td style="padding: 20px; text-align: center;">
                <h1>⭐ Star Cabo Transportations</h1>
                <h2 style="color: #27ae60; margin-bottom: 20px;">Request Confirmation</h2>
